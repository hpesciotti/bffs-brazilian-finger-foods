...
urlpatterns = [
    ...
    path('best_seller/<int:product_id>/',
         views.best_seller, name='best_seller'),
    path('update_price/<int:product_id>/',
         views.update_price, name='update_price'),
    path('apply_discount/<int:batch_id>/',
         views.apply_discount, name='apply_discount'),
    path('edit_batch/<int:batch_id>/', views.edit_batch, name='edit_batch'),
    path('delete_batch/<int:batch_id>/',
