...
def admin_panel(request):
    ...
    return render(request, 'shop_admin/admin_panel.html', context)
...
def add_batch(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect(reverse('batch_detail', args=[batch.id]))  # You may need to define a batch detail view
        else:
